...
class Sample_Plugin_Post{
	...
	*/
	private function page_render(){
		...
		$html .= '<td><img src="' . plugins_url('../images/no-image.png', __FILE__ ) . '" width="200px"><br>';
		$html .= '<input type="text"><br><button>画像を選択</button></td>';
		$html .= '</tr>';
		
		$html .= '<tr>';
		$html .= '<th>画像 Alt属性 (必須)</th>';
		$html .= '<td><input type=""><br>alt属性のテキストを入力します。</td>';
		$html .= '</tr>';
		...
		$html .= '<tr>';
		$html .= '<th>Class名</th>';
		$html .= '<td><input type="text"><br>バナー画像にクラス（複数可）を追加することができます。「class=""」は不要です。
複数設定する場合は、半角スペースで区切ります。</td>';
		$html .= '</tr>';
		
		$html .= '<tr>';
		$html .= '<th>ID名</th>';
		$html .= '<td><input type=""><br>バナー画像にIDを追加することができます。「id=""」は不要です。</td>';
		$html .= '</tr>';
